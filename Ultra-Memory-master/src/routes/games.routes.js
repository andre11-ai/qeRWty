...
renderSimonBajo, renderSimonMedio, renderSimonDificil, rendermemoramafacil, rendermemoramamedio, rendermemoramadificil, rendercarybajo, rendercarymedio, rendercarydificil, rendervelofacil, rendervelomedio, rendervelodificil, rendergalaxia} = require('../controllers/games.controller')
...
router.get('/games/Estresado/Galaxy attack/Galaxy attack/canvasInvader', isAuthenticated, rendergalaxia);
