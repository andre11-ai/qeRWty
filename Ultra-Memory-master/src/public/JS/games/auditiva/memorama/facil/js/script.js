...
const MAXIMOS_INTENTOS = 20, // Intentos máximos que tiene el jugador
    ...
    NOMBRE_IMAGEN_OCULTA = "../../../../../../IMG/games/imgmemorama/question.png"; // La imagen que se muestra cuando la real está oculta
new Vue({
    el: "#app",
    data: () => ({
        // La ruta de las imágenes. Puede ser relativa o absoluta
        imagenes: [
            "../../../../../../IMG/games/imgmemorama/cabra.jpg",
            "../../../../../../IMG/games/imgmemorama/conejo.jpg",
            "../../../../../../IMG/games/imgmemorama/leon.jpg",
            "../../../../../../IMG/games/imgmemorama/oveja.jpg",
            "../../../../../../IMG/games/imgmemorama/perro.jpg",
            "../../../../../../IMG/games/imgmemorama/gato.jpg",
        ],
        memorama: [],
    ...
    methods: {
        ...
        indicarFracaso() {
            Swal.fire({
                    title: "Perdiste",
                    html: `
                <img class="img-fluid" src="../../../../../../IMG/games/imgmemorama/perdiste.png" alt="Perdiste">
